...
import tv.acfun.im.cas.user.model.AdUser;
 ...
 */
public class AcPersonInfoResolver implements PrincipalResolver {
    ...
    public final Principal resolve(final Credential credential) {
        ...
        setUserInfoHandler(convertedAttributes,principalId);
    ...
    private void setUserInfoHandler(Map<String, Object> convertedAttributes, String userId){
        AdUser adUser = acUserService.findAdUserByUserName(userId);
        convertedAttributes.put("id",adUser.getId());
        convertedAttributes.put("isadmin",adUser.getIsadmin());
        convertedAttributes.put("realname",adUser.getRealname());
        convertedAttributes.put("roles",adUser.getRoles());
        convertedAttributes.put("mobile",adUser.getMobile());
        convertedAttributes.put("email",adUser.getEmail());
    }
}
